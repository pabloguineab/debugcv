...
const jobsItems = [
    { title: "Job Search", url: "/dashboard/job-search", icon: Globe, animation: "hover:animate-[icon-globe-rotate_0.6s_ease-in-out]" },
    { title: "Application Board", url: "/dashboard/application-board", icon: ClipboardList, animation: "hover:animate-[icon-bounce_0.5s_ease-in-out]" },
];

const resumesItems = [
    { title: "My Versions", url: "/dashboard/resumes", icon: FileText, animation: "hover:animate-[icon-bounce_0.5s_ease-in-out]" },
    { title: "ATS Score", url: "/dashboard/resumes/ats-score", icon: Target, animation: "hover:animate-[icon-pulse_0.5s_ease-in-out]" },
    { title: "Cover Letters", url: "/dashboard/cover-letters", icon: PenTool, animation: "hover:animate-[icon-pen-write_0.5s_ease-in-out]" },
];

const interviewItems = [
    { title: "AI Simulator", url: "/dashboard/interview-coach", icon: Bot, animation: "hover:animate-[icon-shake_0.5s_ease-in-out]" },
    { title: "Playbooks", url: "/dashboard/playbooks", icon: BookOpen, animation: "hover:animate-[icon-bounce_0.5s_ease-in-out]" },
];
                            ...
                            <SidebarMenuItem>
                                <SidebarMenuButton asChild>
                                    <Link href="/dashboard" className="flex items-center gap-3 w-full my-0.5">
                                        <LayoutDashboard className="size-[18px] hover:animate-[icon-pulse_0.5s_ease-in-out]" />
                ...
                <SidebarMenu>
                    <SidebarMenuItem>
                        <SidebarMenuButton asChild>
                            ...
                            >
                                <Gem className="size-[18px] hover:animate-[icon-sparkle_0.5s_ease-in-out]" />
                    ...
                    <SidebarMenuItem>
                        <SidebarMenuButton asChild>
                            ...
                            >
                                <Gift className="size-[18px] hover:animate-[icon-shake_0.5s_ease-in-out]" />
