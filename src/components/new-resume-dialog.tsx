    ...
    const handleQuickPaste = async () => {
        try {
            ...
            if (text) {
                ...
                // Optionally try to extract title from text or leave it empty?
                // For now just pasting into description as per original behavior.
            }
        } catch (err) {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="grid md:grid-cols-2 gap-6 py-4">
                    ...
                    <Card className="border-dashed overflow-hidden flex flex-col h-full">
