...
const RotatingText = forwardRef<any, RotatingTextProps>((props, ref) => {
    ...
    return (
        <motion.span className={cn('flex flex-wrap whitespace-nowrap', mainClassName)} {...rest} layout transition={transition} style={{ display: 'inline-flex' }}>
            <span className="sr-only">{texts[currentTextIndex]}</span>
            <AnimatePresence mode={animatePresenceMode} initial={animatePresenceInitial}>
                <motion.span
                    key={currentTextIndex}
                    className={cn('flex flex-wrap whitespace-nowrap', splitBy === 'lines' ? 'flex-col' : '')}
                    layout
                    aria-hidden="true"
