    ...
    return (
        <div className="relative flex flex-1 flex-col gap-6 p-4 md:p-6 overflow-hidden">
            ...
            >
                ...
                <div className="flex-1 flex items-center justify-start relative w-full mt-4 md:mt-8 pt-20 md:pt-32">

                    {/* Background Animation Glows - Subtle and clean */}
                    <div className="absolute inset-0 overflow-hidden pointer-events-none">
                        <div className="absolute w-[600px] h-[600px] rounded-full bg-gradient-radial from-blue-100/30 to-transparent blur-3xl opacity-50" />
                    </div>
