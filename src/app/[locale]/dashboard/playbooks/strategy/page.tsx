                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        ...
                        <div className="lg:col-span-8 space-y-8">
                            ...
                            <motion.div
                                ...
                                className="bg-white rounded-3xl p-1 overflow-hidden shadow-sm border border-slate-200/60"
                            >
                                <div className="p-8 pb-0">
                                    <h3 className="text-xl font-bold text-slate-900 mb-4 flex items-center">
                                        <Lock className="w-5 h-5 text-slate-400 mr-3" />
                                        {t('recent_questions')}
                                        <span className={`ml-3 text-sm font-medium ${strategyData.questions ? 'text-slate-500 bg-slate-100 border-slate-200' : 'text-blue-600 bg-blue-50 border-blue-100'} px-2.5 py-0.5 rounded-full border flex items-center justify-center min-w-[2rem]`}>
                                    ...
                                    {isUnlocked ? (
                                        <div className="px-8 pb-8 space-y-4">
                                            {(strategyData.questions || []).map((q, i) => (
                                                <div key={i} className="p-4 bg-indigo-50/50 rounded-xl border border-indigo-100 flex gap-3 items-start">
                                            ...
                                            <div className="mt-6 p-4 bg-green-50 border border-green-100 rounded-xl flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p className="font-bold text-green-800">{t('report_unlocked')}</p>
                                                    <p className="text-sm text-green-600">{t('report_unlocked_desc')}</p>
                                                </div>
                                            </div>
                                        </div>
                                    ) : (
                                        <>
                                            <div className="px-8 pb-8 space-y-4 filter blur-sm select-none opacity-50">
                                            ...
                                            <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-t from-white via-white/80 to-transparent">
                                                <button
                                                    ...
                                                    className="px-8 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-full shadow-lg shadow-indigo-500/30 transition-all transform hover:scale-105 flex items-center gap-2"
                                                >
