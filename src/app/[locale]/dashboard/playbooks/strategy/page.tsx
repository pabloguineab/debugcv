...
function StrategyContent() {
    ...
    return (
        <div className={`w-full bg-slate-50 font-sans ${loading ? 'min-h-screen overflow-hidden' : ''}`}>
                                    ...
                                    {isUnlocked ? (
                                        <div className="px-5 pb-5 space-y-3">
                                            {(strategyData.questions || []).map((q, i) => (
                                                <div key={i} className="p-3 bg-indigo-50/50 rounded-lg border border-indigo-100 flex gap-2 items-start">
                                                    <div className="mt-0.5 w-4 h-4 rounded-full bg-indigo-100 flex items-center justify-center shrink-0">
                                            ...
                                            <div className="mt-4 p-3 bg-green-50 border border-green-100 rounded-lg flex items-center gap-2">
                                                ...
                                                <div>
                                                    <p className="text-xs font-semibold text-green-800">{t('report_unlocked')}</p>
                                                    <p className="text-xs text-green-600">{t('report_unlocked_desc')}</p>
                                                </div>
                                            </div>
                                        </div>
                                    ) : (
